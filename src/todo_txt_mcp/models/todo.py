...
class TodoItem(BaseModel):
    ...
    priority: Optional[str] = Field(default=None, description="Priority level (A-Z)")
    creation_date: Optional[date] = Field(default=None, description="Date when todo was created")
    completion_date: Optional[date] = Field(default=None, description="Date when todo was completed")
    ...
    @classmethod
    def from_pytodotxt_task(cls, task: pytodotxt.Task, task_id: Optional[str] = None) -> "TodoItem":
