...
def register_list_tools(mcp: FastMCP, todo_service: TodoService) -> None:
    ...
    @mcp.tool()
    def list_todos(include_completed: bool = False) -> dict:
        """
            ...
            "todos": [
                {
                    ...
                    "creation_date": todo.creation_date.isoformat() if todo.creation_date else None,
                    "completion_date": todo.completion_date.isoformat() if todo.completion_date else None,
                    "projects": sorted(list(todo.projects)),
                    "contexts": sorted(list(todo.contexts)),
    ...
    @mcp.tool()
    def search_todos(query: str, include_completed: bool = False) -> dict:
        """
    ...
    @mcp.tool()
    def filter_by_priority(priority: str, include_completed: bool = False) -> dict:
        """
        ...
        """
        todos = todo_service.filter_by_priority(priority, include_completed=include_completed)
    ...
    @mcp.tool()
    def filter_by_project(project: str, include_completed: bool = False) -> dict:
        """
        ...
        Returns:
            Dictionary containing filtered todos
        """
        todos = todo_service.filter_by_project(project, include_completed=include_completed)
    ...
    @mcp.tool()
    def filter_by_context(context: str, include_completed: bool = False) -> dict:
        """
        ...
        Returns:
            Dictionary containing filtered todos
        """
        todos = todo_service.filter_by_context(context, include_completed=include_completed)
