...
def register_crud_tools(mcp: FastMCP, todo_service: TodoService) -> None:
    ...
    def add_todo(
        ...
        try:
            ...
            # Validate priority
            if priority and (len(priority) != 1 or not priority.isalpha() or not priority.isupper()):
                return {
            ...
            return {
                ...
                "todo": {
                    ...
                    "creation_date": new_todo.creation_date.isoformat() if new_todo.creation_date else None,
                    "completion_date": new_todo.completion_date.isoformat() if new_todo.completion_date else None,
                    "projects": sorted(list(new_todo.projects)),
                    "contexts": sorted(list(new_todo.contexts)),
    ...
    def reload_todos() -> dict:
        ...
        try:
            ...
            return {
                "error": f"Failed to reload todos: {str(e)}"
            } 