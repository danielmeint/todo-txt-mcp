...
class TodoService:
    ...
    def search_todos(self, query: str, include_completed: bool = False) -> List[TodoItem]:
    ...
    def filter_by_priority(self, priority: str, include_completed: bool = False) -> List[TodoItem]:
        """Filter todos by priority."""
        todos = self.list_todos(include_completed=include_completed)
        return [todo for todo in todos if todo.priority == priority]
    
    def filter_by_project(self, project: str, include_completed: bool = False) -> List[TodoItem]:
        """Filter todos by project."""
        todos = self.list_todos(include_completed=include_completed)
        return [todo for todo in todos if project in todo.projects]
    
    def filter_by_context(self, context: str, include_completed: bool = False) -> List[TodoItem]:
