...
'''
        ...
        assert config.todo_file_path == Path("/Users/alice/Documents/todo-txt/my-todo.txt")
        assert config.done_file_path == Path("/Users/alice/Documents/todo-txt/my-done.txt")
